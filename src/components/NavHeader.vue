                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1"
                     v-model="userName"
                     name="loginname" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password"
                     v-model="userPwd"
                     tabindex="2"  name="password" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" @keyup.enter="login">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" @click="login" class="btn-login">登  录</a>
              </div>
            </div>
          </div>
        </div>
